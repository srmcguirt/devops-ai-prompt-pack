# DevOps AI Prompt Pack by Shane McGuirt
...
**Built by [Shane McGuirt](https://srmcguirt.dev) — engineers who've been on-call at 3 AM.** These prompts encode the patterns we wish we'd had when we started.
